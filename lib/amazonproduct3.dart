...
class amzpro3 extends StatefulWidget {
  const amzpro3({Key? key}) : super(key: key);

  @override
  State<amzpro3> createState() => _amzpro3State();
}

class _amzpro3State extends State<amzpro3> {
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(" noise modern series smartwatch \n at  ₹3,990.00",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold)),
                  ),
                  Container(
                    height: 50,
                    width: 50,
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: AssetImage('assets/noisewatch.png'),
                        fit: BoxFit.fill,
                      ),
                    ...
                    children: [
                              ...
                              child: CarouselSlider.builder(
                                ...
                                itemBuilder: (BuildContext context, int itemIndex, int Index) =>
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        image: DecorationImage(
                                            image:AssetImage("assets/realmewatch.png"),fit: BoxFit.fill
                      ...
                      Row(
                        children: [
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text("Brand: Realme",style: TextStyle(color: Colors.blue,fontSize: 20),),
                          ),
                          Padding(
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text("The brand-new H2 chip carries out more functions than ever, using computational algorithms to deliver even smarter noise cancellation, superior three-dimensional sound and more efficient battery life — all at once.",style: TextStyle(fontStyle: FontStyle.normal,fontWeight: FontWeight.bold),),
                      )
                    ],
                  )
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text('4,000',style: TextStyle(fontWeight: FontWeight.bold,fontSize:30,color: Colors.black)),
                    ...
                    Padding(
                        ...
                        child: RichText(text: TextSpan(
                            ...
                            children: const <TextSpan>[
                              TextSpan(text: "₹5,990",style: TextStyle(fontSize: 20,color: Colors.black54,decoration: TextDecoration.lineThrough),),
                            ]
                        ))
                    ),
