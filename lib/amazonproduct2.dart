...
class amzpro2 extends StatefulWidget {
  const amzpro2({Key? key}) : super(key: key);

  @override
  State<amzpro2> createState() => _amzpro2State();
}

class _amzpro2State extends State<amzpro2> {
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: AssetImage('assets/realmebuds.png'),
                        fit: BoxFit.fill,
                      ),
                    ...
                    children: [
                              ...
                              child: CarouselSlider.builder(
                                ...
                                itemBuilder: (BuildContext context, int itemIndex, int Index) =>
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        image: DecorationImage(
                                            image:AssetImage("assets/airpods.png"),fit: BoxFit.fill
                      ...
                      Row(
                        children: [
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text("Brand: Airpods pro",style: TextStyle(color: Colors.blue,fontSize: 20),),
                          ),
                          Padding(
